...
EVENT_DICT = { "2-year" : [ int(2), [91.0, $ ev_2yr_max    $],], 
               "5-year" : [ int(5), [133.0, $ ev_5yr_max    $],],
               "10-year" : [ int(10), [170.0, $ ev_10yr_max   $],],
               "25-year" : [ int(25), [226.0, $ ev_25yr_max   $],],
               "50-year" : [ int(50), [275.0, $ ev_50yr_max   $],],
               "100-year" : [ int(100), [332.0, $ ev_100yr_max  $],], }
